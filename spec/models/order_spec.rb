...
RSpec.describe Order, type: :model do
  ...
  describe "#total_cost" do
    it "returns total cost of an order" do
      product = Product.new({name: "Sea Anemone", price: 5.00, photo_url: "http://www.cabrillomarineaquarium.org/_photos/species-green-sea-anemone.jpg", description: "Is it fluffy, or slimy?", quantity: 5, merchant_id: 1, height: 10, width: 2, length: 100, weight: 24})
